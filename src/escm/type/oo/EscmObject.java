...
public class EscmObject extends MetaObject implements Callable {
  ...
  public String docstring() {
    StringBuilder sb = new StringBuilder("Object instance of class: ");
    sb.append(escmClass.readableName());
    int n = sb.length();
    sb.append('\n');
    for (int i = 0; i < n; i++)
      sb.append('-');
    sb.append("\n\n");
    sb.append(escmClass.docstring());
    return sb.toString();
  }
  ...
  public Trampoline.Bounce callWith(ArrayList<Datum> args, Trampoline.Continuation continuation) throws Exception {
    if (!has("->procedure"))
      throw new Exceptionf("Object of class %s error: can't be applied without a \"->procedure\" method!",
          escmClass.readableName());
    Datum procedure = get("->procedure");
    if (!(procedure instanceof MethodProcedure))
      throw new Exceptionf("Object of class %s error: \"->procedure\" property %s isn't a method!",
          escmClass.readableName(), procedure.profile());
  ...
  ////////////////////////////////////////////////////////////////////////////
  // Update the Super Object (& return the updated super) (equivalent to the
  //////////////////////////////////////////////////////////////////////////// "super!"
  //////////////////////////////////////////////////////////////////////////// macro)
  ...
  public Trampoline.Bounce updateSuper(ArrayList<Datum> parameters, Trampoline.Continuation continuation)
      throws Exception {
    if (superObject == null)
  ...
  public boolean instanceOf(EscmInterface i) {
    EscmObject obj = this;
    while (obj != null) {
      if (obj.escmClass.hasInterface(i))
        return true;
      BooleanBox bb = new BooleanBox();
  ...
  public boolean equal(Object o) {
    if (!(o instanceof EscmObject) || ((EscmObject) o).escmClass != escmClass)
      return false;
  ...
  private EscmObject(int ignore, EscmClass escmClass, EscmObject superObject,
      ConcurrentHashMap<String, Datum> propsCopy) {
    this.escmClass = escmClass;
    if (superObject == null) {
