...
public class TypeChecker {
  ...
  private static class PredicateGenerator implements ValueGenerator<Predicate> {
    ...
    public Predicate primitiveBigInt() {
      return (env, value) -> {
        if ((value instanceof escm.type.number.Real) == false)
          return false;
        escm.type.number.Real real = (escm.type.number.Real) value;
        return real.isExact() && real.isInteger();
      };
    }
