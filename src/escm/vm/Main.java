...
public class Main {
  ...
  private static void printReplIntro() {
    ...
    sb.append("A    |@|   |#|@|###||||###|######/^\\######|###||||###|@|#|   |@|    U   E:::EEEEEE        SSSSSS:::SC:::C        M:::M  M:::::M  M:::M\n");
    sb.append("@    | |   |#| |###|##|#T#|####/     \\####|#1#|##|###| |#|   | |    R   E::E                   S::::S:::C        M:::M   M:::M   M:::M\n");
    sb.append("B    |@|   |#|@|###|/\\|#A#|##/         \\##|#0#|/\\|###|@|#|   |@|    @   E::E    EEEE           S::::SC:::C   CCCCM:::M    MMM    M:::M\n");
    sb.append("E    | |   |#| |###||||#S#|#(           )#|#2#||||###| |#|   | |    D EE:::EEEEEE::ESSSSSS     S::::SC::::CCCC::CM:::M     M     M:::M\n");
    sb.append("L    |@|   |#|@|###|##|#N#|##\\         /##|#2#|##|###|@|#|   |@|    E E::::::::::::ES:::::SSSSSS::::S C:::::::::CM:::M           M:::M\n");
    sb.append("L    | |   |#| |###|/\\|#I#|###|       |###|#2#|/\\|###| |#|   | |    @ E::::::::::::ES:::::::::::::SS   CCC::::::CM:::M           M:::M\n");
    sb.append("E    |@|   |#|@|###||||#M#|###|       |###|#1#||||###|@|#|   |@|    M EEEEEEEEEEEEEE SSSSSSSSSSSSS    @@@ CCCCCCCMMMMM           MMMMM\n");
    sb.append("@    | |   |#| |###||||###|###|       |###|###||||###| |#|   | |    A@@@@@@@@@@@@@@ @@@@@@@@@@@@@        @@@@@@@@@@@@           @@@@@\n");
    sb.append("J   _|_|___|#|_|###|##|###|###|_______|###|###|##|###|_|#|___|_|_   @\n");
    sb.append("A   |###|###################################################|###|   V        Copyright (c) Jordan Candide Randleman 2021-2022\n");
    sb.append(String.format("A   |###|###############/|=================|\\###############|###|   I                  Eerina's Scheme: Version %.1f\n",SystemPrimitives.VERSION));
    sb.append("N  /-------------------/ /=================\\ \\-------------------\\  E              Type (help) for Help, (exit) to Exit\n");
    sb.append("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n");
