...
public class ModulePrimitives {
  ...
  public static class Reload extends PrimitiveSyntax {
    ...
    public String docstring() {
      return "Forcefully reload <module-alias-symbol>. Note that <import> caches modules by default.";
    }
