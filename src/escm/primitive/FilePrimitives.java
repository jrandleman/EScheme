...
public class FilePrimitives {
  ...
  public static class FileRead extends Primitive {
    ...
    public static ArrayList<Datum> readBufferAsArrayList(String filename, String buffer) throws Exception {
      ...
      escm.util.Pair<Datum, Integer> result = Reader.nullableRead(buffer, source,
          Reader.GIVE_DETAILED_INCOMPLETE_ERRORS);
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(file-read <filename-string>) didn't receive exactly 1 string: %s",
  ...
  public static class FileReadString extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(file-read-string <filename-string>) didn't receive exactly 1 string: %s",
            Exceptionf.profileArgs(parameters));
      return new escm.type.String(
          FileRead.slurpFile(((escm.type.String) parameters.get(0)).value(), "file-read-string"));
    }
  }
  ...
  public static class FileWrite extends Primitive {
    ...
    public static void appendStringToFile(String filename, String str, String callerName) throws Exception {
      try {
        Files.writeString(Path.of(filename), str, new StandardOpenOption[] { StandardOpenOption.CREATE,
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 2 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(file-write <filename-string> <obj>) didn't receive exactly 1 string & 1 obj: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class FileWritePlus extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 2 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(file-write+ <filename-string> <obj>) didn't receive exactly 1 string & 1 obj: %s",
            Exceptionf.profileArgs(parameters));
      FileWrite.appendStringToFile(((escm.type.String) parameters.get(0)).value(), parameters.get(1).write(),
          "file-write+");
      return escm.type.Void.VALUE;
    }
  }
  ...
  public static class FileDisplay extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 2 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(file-display <filename-string> <obj>) didn't receive exactly 1 string & 1 obj: %s",
            Exceptionf.profileArgs(parameters));
      FileWrite.writeStringToFile(((escm.type.String) parameters.get(0)).value(), parameters.get(1).display(),
          "file-display");
      return escm.type.Void.VALUE;
    }
  }
  ...
  public static class FileDisplayPlus extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 2 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(file-display+ <filename-string> <obj>) didn't receive exactly 1 string & 1 obj: %s",
            Exceptionf.profileArgs(parameters));
      FileWrite.appendStringToFile(((escm.type.String) parameters.get(0)).value(), parameters.get(1).display(),
          "file-display+");
      return escm.type.Void.VALUE;
    }
  }
  ...
  public static class FilePprint extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 2 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(file-pretty-print <filename-string> <obj>) didn't receive exactly 1 string & 1 obj: %s",
            Exceptionf.profileArgs(parameters));
      FileWrite.writeStringToFile(((escm.type.String) parameters.get(0)).value(), parameters.get(1).pprint(),
          "file-pretty-print");
      return escm.type.Void.VALUE;
    }
  }
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 2 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf(
            "'(file-pretty-print+ <filename-string> <obj>) didn't receive exactly 1 string & 1 obj: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class IsPathP extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(path? <path-string>) didn't receive exactly 1 string: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class IsDirectoryP extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(directory? <directory-path-string>) didn't receive exactly 1 string: %s",
            Exceptionf.profileArgs(parameters));
      return Boolean.valueOf(logic(Path.of(((escm.type.String) parameters.get(0)).value())));
    }
  }
  ...
  public static class IsFileP extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(file? <file-path-string>) didn't receive exactly 1 string: %s",
            Exceptionf.profileArgs(parameters));
      return Boolean.valueOf(logic(Path.of(((escm.type.String) parameters.get(0)).value())));
    }
  }
  ...
  public static class FileDeleteBang extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(file-delete! <file-path-string>) didn't receive exactly 1 string: %s",
            Exceptionf.profileArgs(parameters));
      return Boolean.valueOf(logic(Path.of(((escm.type.String) parameters.get(0)).value())));
    }
  }
  ...
  public static class DirectoryDeleteBang extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(directory-delete! <directory-path-string>) didn't receive exactly 1 string: %s",
            Exceptionf.profileArgs(parameters));
      return Boolean.valueOf(logic(Path.of(((escm.type.String) parameters.get(0)).value())));
    }
  }
  ...
  public static class DirectoryRecursiveDeleteBang extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf(
            "'(directory-recursive-delete! <directory-path-string>) didn't receive exactly 1 string: %s",
            Exceptionf.profileArgs(parameters));
      return Boolean.valueOf(logic(Path.of(((escm.type.String) parameters.get(0)).value())));
    }
  }
  ...
  public static class PathDeleteBang extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(path-delete! <path-string>) didn't receive exactly 1 string: %s",
            Exceptionf.profileArgs(parameters));
      return Boolean.valueOf(logic(Path.of(((escm.type.String) parameters.get(0)).value())));
    }
  }
  ...
  public static class PathRecursiveDeleteBang extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(path-recursive-delete! <path-string>) didn't receive exactly 1 string: %s",
            Exceptionf.profileArgs(parameters));
      return Boolean.valueOf(logic(Path.of(((escm.type.String) parameters.get(0)).value())));
    }
  }
  ...
  public static class DirectoryEntries extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(directory-entries <directory-path-string>) didn't receive exactly 1 string: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class GeneratePath extends Primitive {
    ...
    public Datum signature() {
      return Pair.List(Pair.List(new Symbol("path")),
          Pair.List(new Symbol("path"), new Symbol("<string>"), Signature.VARIADIC));
    }
    ...
    private static String withoutStartingSeparator(String s) {
      if (s.startsWith(File.separator))
        return s.substring(File.separator.length());
      return s;
    }
  ...
  public static class PathParent extends Primitive {
    ...
    private static int parseCompositionCount(int n, ArrayList<Datum> parameters) throws Exception {
      ...
      if (!(d instanceof Real))
        throw new Exceptionf("'(path-parent <path-string> <optional-positive-int>) 2nd arg isn't a positive int: %s",
            Exceptionf.profileArgs(parameters));
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      ...
      if (n < 1 || n > 2 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(path-parent <path-string> <optional-positive-int>) incorrect args: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class PathFile extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(path-file <path-string>) didn't receive exactly 1 string: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class MakeDirectory extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(make-directory <path-string>) didn't receive exactly 1 string: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class AbsolutePath extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(absolute-path <path-string>) didn't receive exactly 1 string: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class FileExtension extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(file-extension <path-string>) didn't receive exactly 1 string: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class FileHasExtensionP extends Primitive {
    ...
    public Datum signature() {
      return Pair.List(new Symbol("file-has-extension?"), new Symbol("<path-string>"),
          new Symbol("<extension-string>"));
    }
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 2)
        throw new Exceptionf(
            "'(file-has-extension? <path-string> <extension-string>) didn't receive exactly 2 args: %s",
            Exceptionf.profileArgs(parameters));
      Datum pathStrDatum = parameters.get(0);
      if (!(pathStrDatum instanceof escm.type.String))
        throw new Exceptionf("'(file-has-extension? <path-string> <extension-string>) path isn't a string: %s",
            Exceptionf.profileArgs(parameters));
      Datum extStrDatum = parameters.get(1);
      if (!(extStrDatum instanceof escm.type.String))
        throw new Exceptionf("'(file-has-extension? <path-string> <extension-string>) extension isn't a string: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class SwapFileExtension extends Primitive {
    ...
    public Datum signature() {
      return Pair.List(new Symbol("swap-file-extension"), new Symbol("<path-string>"),
          new Symbol("<new-extension-string>"));
    }
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 2)
        throw new Exceptionf(
            "'(swap-file-extension <path-string> <new-extension-string>) didn't receive exactly 2 args: %s",
            Exceptionf.profileArgs(parameters));
      Datum pathStrDatum = parameters.get(0);
      if (!(pathStrDatum instanceof escm.type.String))
        throw new Exceptionf("'(swap-file-extension <path-string> <new-extension-string>) path isn't a string: %s",
            Exceptionf.profileArgs(parameters));
      Datum extStrDatum = parameters.get(1);
      if (!(extStrDatum instanceof escm.type.String))
        throw new Exceptionf("'(swap-file-extension <path-string> <new-extension-string>) extension isn't a string: %s",
            Exceptionf.profileArgs(parameters));
      String pathStr = ((escm.type.String) pathStrDatum).value();
      String extStr = ((escm.type.String) extStrDatum).value();
      Path p = Path.of(pathStr).getFileName();
      if (p == null)
        return new escm.type.String(pathStr + "." + extStr);
      String pString = p.toString();
      int idx = pString.lastIndexOf('.');
      if (idx == -1)
        return new escm.type.String(pathStr + "." + extStr);
  ...
  public static class RemoveFileExtension extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1)
        throw new Exceptionf("'(remove-file-extension <path-string>) didn't receive exactly 1 arg: %s",
            Exceptionf.profileArgs(parameters));
      Datum pathStrDatum = parameters.get(0);
      if (!(pathStrDatum instanceof escm.type.String))
        throw new Exceptionf("'(remove-file-extension <path-string>) path isn't a string: %s",
            Exceptionf.profileArgs(parameters));
      String pathStr = ((escm.type.String) pathStrDatum).value();
      Path p = Path.of(pathStr).getFileName();
      if (p == null)
  ...
  public static class FileSize extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.String))
        throw new Exceptionf("'(file-size <file-path-string>) didn't receive exactly 1 string: %s",
            Exceptionf.profileArgs(parameters));
      try {
        return new escm.type.number.Exact(Files.size(Path.of(((escm.type.String) parameters.get(0)).value())));
      } catch (Exception e) {
        throw new Exceptionf("'(file-size <file-path-string>) couldn't get file size: %s",
            Exceptionf.profileArgs(parameters));
      }
    }
  }
  ...
  public static class MoveFile extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 2)
        throw new Exceptionf("'(move-file <old-path-string> <new-path-string>) didn't receive exactly 2 args: %s",
            Exceptionf.profileArgs(parameters));
      Datum oldPathDatum = parameters.get(0);
      if (!(oldPathDatum instanceof escm.type.String))
        throw new Exceptionf("'(move-file <old-path-string> <new-path-string>) old-path isn't a string: %s",
            Exceptionf.profileArgs(parameters));
      Datum newPathDatum = parameters.get(1);
      if (!(newPathDatum instanceof escm.type.String))
        throw new Exceptionf("'(move-file <old-path-string> <new-path-string>) new-path isn't a string: %s",
            Exceptionf.profileArgs(parameters));
      try {
        Files.move(Path.of(((escm.type.String) oldPathDatum).value()),
            Path.of(((escm.type.String) newPathDatum).value()));
      } catch (Exception e) {
        throw new Exceptionf("'(move-file <old-path-string> <new-path-string>) couldn't move path: %s",
            Exceptionf.profileArgs(parameters));
      }
      return escm.type.Void.VALUE;
    }
  ...
  public static class MoveFileBang extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      ...
      if (directoriesToCreate != null && !IsDirectoryP.logic(directoriesToCreate)) {
        if ((new File(directoriesToCreate.toString())).mkdirs() == false)
          return Boolean.FALSE;
      }
      // Move the file once directories are made
      try {
        Files.move(Path.of(((escm.type.String) oldPathDatum).value()), Path.of(newPathString),
  ...
  public static class CopyFile extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 2)
        throw new Exceptionf("'(copy-file <old-path-string> <new-path-string>) didn't receive exactly 2 args: %s",
            Exceptionf.profileArgs(parameters));
      Datum oldPathDatum = parameters.get(0);
      if (!(oldPathDatum instanceof escm.type.String))
        throw new Exceptionf("'(copy-file <old-path-string> <new-path-string>) old-path isn't a string: %s",
            Exceptionf.profileArgs(parameters));
      Datum newPathDatum = parameters.get(1);
      if (!(newPathDatum instanceof escm.type.String))
        throw new Exceptionf("'(copy-file <old-path-string> <new-path-string>) new-path isn't a string: %s",
            Exceptionf.profileArgs(parameters));
      try {
        Files.copy(Path.of(((escm.type.String) oldPathDatum).value()),
            Path.of(((escm.type.String) newPathDatum).value()));
      } catch (Exception e) {
        throw new Exceptionf("'(copy-file <old-path-string> <new-path-string>) couldn't copy file: %s",
            Exceptionf.profileArgs(parameters));
      }
      return escm.type.Void.VALUE;
    }
  ...
  public static class CopyFileBang extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      ...
      // Move the file once directories are made
      try {
        Files.copy(Path.of(((escm.type.String) oldPathDatum).value()), Path.of(newPathString),
            StandardCopyOption.REPLACE_EXISTING);
      } catch (Exception e) {
        throw new Exceptionf("'(copy-file! <old-path-string> <new-path-string>) couldn't copy! file: %s",
            Exceptionf.profileArgs(parameters));
