...
public class HashmapPrimitives {
  ...
  public static class Hashmap extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() % 2 != 0)
        throw new Exceptionf("'(hashmap <key> <value> ...) didn't receive an even number of args: %s",
  ...
  public static class HashmapKeys extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.Hashmap))
        throw new Exceptionf("'(hashmap-keys <hashmap>) didn't receive exactly 1 hashmap: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class HashmapValues extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof escm.type.Hashmap))
        throw new Exceptionf("'(hashmap-values <hashmap>) didn't receive exactly 1 hashmap: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class IsHashmapKey extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 2)
        throw new Exceptionf("'(hashmap-key? <hashmap> <obj>) expects exactly 2 args: %s",
            Exceptionf.profileArgs(parameters));
      Datum h = parameters.get(0);
      if (!(h instanceof escm.type.Hashmap))
        throw new Exceptionf("'(hashmap-key? <hashmap> <obj>) 1st arg %s isn't a hashmap: %s", h.profile(),
            Exceptionf.profileArgs(parameters));
  ...
  public static class IsHashmapVal extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 2)
        throw new Exceptionf("'(hashmap-val? <hashmap> <obj>) expects exactly 2 args: %s",
            Exceptionf.profileArgs(parameters));
      Datum h = parameters.get(0);
      if (!(h instanceof escm.type.Hashmap))
        throw new Exceptionf("'(hashmap-val? <hashmap> <obj>) 1st arg %s isn't a hashmap: %s", h.profile(),
            Exceptionf.profileArgs(parameters));
  ...
  public static class HashmapSetBang extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 3)
        throw new Exceptionf("'(hashmap-set! <hashmap> <key> <value>) expects exactly 3 args: %s",
            Exceptionf.profileArgs(parameters));
      Datum h = parameters.get(0);
      if (!(h instanceof escm.type.Hashmap))
        throw new Exceptionf("'(hashmap-set! <hashmap> <key> <value>) 1st arg %s isn't a hashmap: %s", h.profile(),
            Exceptionf.profileArgs(parameters));
  ...
  public static class HashmapDeleteBang extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 2)
        throw new Exceptionf("'(hashmap-delete! <hashmap> <key>) expects exactly 2 args: %s",
            Exceptionf.profileArgs(parameters));
      Datum h = parameters.get(0);
      if (!(h instanceof escm.type.Hashmap))
        throw new Exceptionf("'(hashmap-delete! <hashmap> <key>) 1st arg %s isn't a hashmap: %s", h.profile(),
            Exceptionf.profileArgs(parameters));
  ...
  public static class HashmapMerge extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() < 1)
        throw new Exceptionf("'(hashmap-merge <hashmap> ...) expects at least 1 arg: %s",
            Exceptionf.profileArgs(parameters));
      ArrayList<escm.type.Hashmap> hs = new ArrayList<escm.type.Hashmap>();
      for (Datum p : parameters) {
        if (!(p instanceof escm.type.Hashmap))
          throw new Exceptionf("'(hashmap-merge <hashmap> ...) invalid non-hashmap %s given: %s", p.profile(),
              Exceptionf.profileArgs(parameters));
  ...
  public static class HashmapMergeBang extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      ...
      Datum h = parameters.get(0);
      if (!(h instanceof escm.type.Hashmap))
        throw new Exceptionf("'(hashmap-merge! <hashmap> ...) invalid non-hashmap %s given: %s", h.profile(),
            Exceptionf.profileArgs(parameters));
  ...
  public static class Hashcode extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      ...
      if (parameters.size() == 1)
        return new Exact(parameters.get(0).hashCode());
