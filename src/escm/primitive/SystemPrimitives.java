...
public class SystemPrimitives {
  ...
  public static final String ESCM_EXECUTION_COMMAND = " " + JvmPathPrefix.VALUE + "java -classpath \"" + EscmPath.VALUE
      + File.separator + "bin\" Main ";
  ...
  public static class Load extends PrimitiveCallable {
    ...
    public static String addStringPaths(String path1, String path2) {
      ...
      if (n == 0)
        return path2;
      if (path1.charAt(n - 1) == File.separatorChar)
        return path1 + path2;
    ...
    public static String getPath(String dir, String file) {
      int n = dir.length();
      if (n == 0 || FilePrimitives.IsAbsolutePath.logic(file))
        return file;
      return addStringPaths(dir, file);
    }

    public static Trampoline.Bounce evalEachExpression(ArrayList<Datum> exprs, int i,
        EscmCallStack.Frame originalCallStack, Environment definitionEnvironment, Trampoline.Continuation continuation)
        throws Exception {
      int n = exprs.size();
      if (i >= n)
      ...
      if (i + 1 == n) {
        ...
        nextContinuation = (value) -> () -> {
          ...
          if (value instanceof escm.type.port.Eof)
            return continuation.run(Void.VALUE);
      ...
      return escm.vm.Compiler.run(exprs.get(i), definitionEnvironment, (compiled) -> () -> {
        return escm.vm.Interpreter.run(new ExecutionState(definitionEnvironment, escm.vm.Assembler.run(compiled)),
            nextContinuation);
      });
    }

    private static Trampoline.Bounce loadESchemeFile(String primitiveName, String filename,
        Environment definitionEnvironment, Trampoline.Continuation continuation) throws Exception {
    ...
    public static Trampoline.Bounce logic(String primitiveName, String filename, Environment definitionEnvironment,
    ...
    public Trampoline.Bounce callWith(ArrayList<Datum> parameters, Trampoline.Continuation continuation)
      ...
      if (n < 1 || n > 2)
        throw new Exceptionf("'(load <optional-directory> <filename>) invalid args: %s",
            Exceptionf.profileArgs(parameters));
      if (n == 1) {
        if (!(parameters.get(0) instanceof escm.type.String))
          throw new Exceptionf("'(load <optional-directory> <filename>) <filename> isn't a string: %s",
              Exceptionf.profileArgs(parameters));
        filename = ((escm.type.String) parameters.get(0)).value();
      } else {
        if (!(parameters.get(0) instanceof escm.type.String))
          throw new Exceptionf("'(load <optional-directory> <filename>) <directory> isn't a string: %s",
              Exceptionf.profileArgs(parameters));
  ...
  public static class LoadOnce extends PrimitiveCallable {
    ...
    public Trampoline.Bounce callWith(ArrayList<Datum> parameters, Trampoline.Continuation continuation)
      ...
      String directory = "", filename = "";
      if (n < 1 || n > 2)
        throw new Exceptionf("'(load-once <optional-directory> <filename>) invalid args: %s",
            Exceptionf.profileArgs(parameters));
      if (n == 1) {
        if (!(parameters.get(0) instanceof escm.type.String))
          throw new Exceptionf("'(load-once <optional-directory> <filename>) <filename> isn't a string: %s",
              Exceptionf.profileArgs(parameters));
        filename = ((escm.type.String) parameters.get(0)).value();
      } else {
        if (!(parameters.get(0) instanceof escm.type.String))
          throw new Exceptionf("'(load-once <optional-directory> <filename>) <directory> isn't a string: %s",
              Exceptionf.profileArgs(parameters));
        if (!(parameters.get(1) instanceof escm.type.String))
          throw new Exceptionf("'(load-once <optional-directory> <filename>) <filename> isn't a string: %s",
              Exceptionf.profileArgs(parameters));
  ...
  public static class ExecuteCommand extends Primitive {
    ...
    public Datum signature() {
      return Pair.List(
          ...
          Pair.List(new Symbol("system"), new Symbol("<command-str>"), new Symbol("<env-var-str-list>"),
              new Symbol("<directory-str>")),
          Pair.List(new Symbol("system"), new Symbol("<millisecond-timeout>"), new Symbol("<command-str>")),
          Pair.List(new Symbol("system"), new Symbol("<millisecond-timeout>"), new Symbol("<command-str>"),
              new Symbol("<env-var-str-list>")),
          Pair.List(new Symbol("system"), new Symbol("<millisecond-timeout>"), new Symbol("<command-str>"),
              new Symbol("<directory-str>")),
          Pair.List(new Symbol("system"), new Symbol("<millisecond-timeout>"), new Symbol("<command-str>"),
              new Symbol("<env-var-str-list>"), new Symbol("<directory-str>")));
    }
    ...
    private static String[] convertStringListToStringArray(Datum list, String listContentType,
      ...
      while (list instanceof escm.type.Pair) {
        ...
        if (!(content instanceof escm.type.String))
          throw new Exceptionf(
              "'(system <optional-millisecond-timeout> <cmd-str> <optional-env-var-str-list> <optional-dir-str>) %s list value %s isn't a string: %s",
              listContentType, content.profile(), Exceptionf.profileArgs(parameters));
    ...
    public static Long parseMillisecondTimeout(ArrayList<Datum> parameters) throws Exception {
      ...
      if (!(timeout instanceof Real))
        return null;
      Real r = (Real) timeout;
      if (r.isNaN() || r.isNegative())
        return (long) 0;
      if (r.isPositive() && r.isInfinite())
        return null;
      return r.longValue();
    }
    ...
    private static String parseCommand(Long timeout, ArrayList<Datum> parameters) throws Exception {
      ...
      if (parameters.size() < cmdIdx + 1)
        throw new Exceptionf(
            "'(system <optional-millisecond-timeout> <cmd-str> <optional-env-var-str-list> <optional-dir-str>) invalid number of args: %s",
            Exceptionf.profileArgs(parameters));
      Datum cmd = parameters.get(cmdIdx);
      if (cmd instanceof escm.type.String)
        return ((escm.type.String) cmd).value();
      throw new Exceptionf(
          "'(system <optional-millisecond-timeout> <cmd-str> <optional-env-var-str-list> <optional-dir-str>) <cmds> isn't a string: %s",
          Exceptionf.profileArgs(parameters));
    }
    ...
    private static String[] parseEnvironmentVariables(Long timeout, ArrayList<Datum> parameters) throws Exception {
      ...
      if (parameters.size() < envpIdx + 1)
        return null;
      Datum envp = parameters.get(envpIdx);
      if (envp instanceof escm.type.String)
        return null; // working directory
      if (escm.type.Pair.isList(envp))
        return convertStringListToStringArray(envp, "environment variables", parameters);
      throw new Exceptionf(
          "'(system <optional-millisecond-timeout> <cmd-str> <optional-env-var-str-list> <optional-dir-str>) <env-vars> isn't a str list: %s",
          Exceptionf.profileArgs(parameters));
    }

    private static File parseWorkingDirectory(Long timeout, String[] envp, ArrayList<Datum> parameters)
        throws Exception {
      int dirIdx = timeout == null ? 2 : 3;
      if (envp == null)
        --dirIdx;
      if (parameters.size() < dirIdx + 1)
        return null;
      Datum dir = parameters.get(dirIdx);
      if (dir instanceof escm.type.String)
        return new File(((escm.type.String) dir).value());
      throw new Exceptionf(
          "'(system <optional-millisecond-timeout> <cmd-str> <optional-env-var-str-list> <optional-dir-str>) <dir> isn't a str: %s",
          Exceptionf.profileArgs(parameters));
    }
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      ...
      return escm.type.Pair.List(new escm.type.String(result.out), new escm.type.String(result.err),
          new Exact(result.exit));
    }
  }
  ...
  public static class ExecuteEscmProgram extends Primitive {
    ...
    public Datum signature() {
      return Pair.List(
          ...
          Pair.List(new Symbol("escm"), new Symbol("<millisecond-timeout>"), new Symbol("<escm-file>"),
              new Symbol("<argv>"), Signature.VARIADIC));
    }
    ...
    private static String parseEscmProgramCommand(Long timeout, ArrayList<Datum> parameters) throws Exception {
      ...
      if (n < cmdIdx + 1)
        throw new Exceptionf(
            "'(escm <optional-millisecond-timeout> <escm-file> <optional-argv> ...) invalid number of args: %s",
            Exceptionf.profileArgs(parameters));
      if (!(parameters.get(cmdIdx) instanceof escm.type.String))
        throw new Exceptionf(
            "'(escm <optional-millisecond-timeout> <escm-file> <optional-argv> ...) <escm-file> isn't a string: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class EscmGetModuleName extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof Symbol))
        throw new Exceptionf("'(escm-get-module-name <module-path-symbol>) didn't receive exactly 1 symbol: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class EscmLoadModule extends PrimitiveCallable {
    ...
    public Datum signature() {
      return Pair.List(
          ...
          Pair.List(new Symbol("escm-load-module"), new Symbol("<filepath-string>"),
              new Symbol("<module-path-symbol>")));
    }
    ...
    public static Path addPaths(Path path1, Path path2) {
      ...
      if (n == 0)
        return path2;
      if (s1.charAt(n - 1) == File.separatorChar)
    ...
    private static Symbol[] getModulePathSymbols(Symbol modulePath) throws Exception {
      if (ObjectAccessChain.is(modulePath))
        return ObjectAccessChain.parse(modulePath);
    ...
    private static String getModuleFileName(Path moduleDirectory, String moduleName) throws Exception {
      for (File entry : (new File(moduleDirectory.toString())).listFiles()) {
        ...
        if (filename.length() != 0 && filename.charAt(0) != '.'
            && extractFileWithoutExtension(filename).equals(moduleName)) {
          return filename;
        }
      }
      return null;
    ...
    private static String getModuleAbsoluteFilePath(String moduleName, Symbol[] modulePath, String filePath,
        ArrayList<Datum> parameters) throws Exception {
      ...
      if (moduleAbsolutePath == null)
        throw new InvalidModuleException(
            "'(escm-load-module <optional-filepath-string> <module-path-symbol>) module path doesn't exist: %s",
            Exceptionf.profileArgs(parameters));
    ...
    public static Trampoline.Bounce logic(String primitiveName, boolean forcedImport, String moduleName,
        String absoluteFilePath, Trampoline.Continuation continuation) throws Exception {
    ...
    public Trampoline.Bounce callWith(ArrayList<Datum> parameters, Trampoline.Continuation continuation)
      ...
      if (n < 1 || n > 2)
        throw new Exceptionf(
            "'(escm-load-module <optional-filepath-string> <module-path-symbol>) invalid arg signature: %s",
            Exceptionf.profileArgs(parameters));
      ...
      if (n == 1) {
        if (!(parameters.get(0) instanceof Symbol))
          throw new Exceptionf(
              "'(escm-load-module <optional-filepath-string> <module-path-symbol>) <module-path> isn't a symbol: %s",
              Exceptionf.profileArgs(parameters));
        moduleName = (Symbol) parameters.get(0);
        if (moduleName.hasSourceInformation()) {
          filePath = moduleName.source().fileName(); // import relative to the location of the importer's file (if
                                                     // available)
        }
      } else {
        if (!(parameters.get(0) instanceof escm.type.String))
          throw new Exceptionf(
              "'(escm-load-module <optional-filepath-string> <module-path-symbol>) <filepath> isn't a string: %s",
              Exceptionf.profileArgs(parameters));
  ...
  public static class EscmReloadModule extends PrimitiveCallable {
    ...
    public Trampoline.Bounce callWith(ArrayList<Datum> parameters, Trampoline.Continuation continuation)
      ...
      if (parameters.size() != 1 || !(parameters.get(0) instanceof EscmModule))
        throw new Exceptionf("'(escm-reload-module <module>) didn't receive exactly 1 module: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class ModulePath extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof EscmModule))
        throw new Exceptionf("'(module-path <module>) didn't receive exactly 1 module: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class ModuleBindings extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 1 || !(parameters.get(0) instanceof EscmModule))
        throw new Exceptionf("'(module-bindings <module>) didn't receive exactly 1 module: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class EscmDefineParameter extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 2 || !(parameters.get(0) instanceof Symbol))
        throw new Exceptionf("'(escm-define-parameter <symbol> <obj>) invalid args: %s",
            Exceptionf.profileArgs(parameters));
  ...
  public static class EscmSetParameterBang extends Primitive {
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      if (parameters.size() != 2 || !(parameters.get(0) instanceof Symbol))
        throw new Exceptionf("'(escm-set-parameter! <symbol> <obj>) invalid args: %s",
            Exceptionf.profileArgs(parameters));
    ...
    public Datum callWith(ArrayList<Datum> parameters) throws Exception {
      ...
      if (n == 1) {
        ...
        if (!(varName instanceof escm.type.String))
          throw new Exceptionf("'(getenv <optional-var-name-str>) <var-name> isn't a string: %s",
              Exceptionf.profileArgs(parameters));
        try {
