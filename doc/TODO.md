...
- NOTE: CHANGE `Installer.java` TO ACCEPT A `-v`, `--verbose` FLAG TO PRINT OUT PROGRESS MESSAGES
  
  => BY DEFAULT ONLY PRINT FATAL ERROR / SUCCESS MESSAGES
  
  => MENTION THIS FLAG OPTION IN `README.md` !!!





- DESCRIBE THE POSSIBLE COMMAND-LINE FLAGS TO ESCM IN `README.md` !!!
...
- IN `Main`: ALSO PRINT OUT THE POSSBILE HELP CMD LINE OPTIONS IF GIVEN A FILE THAT DOESN'T EXIST
