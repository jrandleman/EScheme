...
public class Installer {
  ...
  private static String getJavaStdlibLoaderGeneratorContents(String escmDir, String generatedFilesDir) {
    ...
    javaStdlibLoader.append("//    or `PrimitiveCallable` classes. These instances' names are then used to generate \n");
    javaStdlibLoader.append("//    an efficient loader that defines them as EScheme primitive function arguments\n");
    javaStdlibLoader.append("//    in a given global scope.\n");
    javaStdlibLoader.append("\n");
