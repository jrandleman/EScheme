...
public class Installer {
  ...
  private static void generateEscmPath(String escmDir) {
    Path escmPathPath = Path.of(escmDir+File.separator+"src"+File.separator+"escm"+
                                        File.separator+"vm"+File.separator+"runtime"+
                                        File.separator+"EscmPath.java");
    ...
    escmPath.append("\n");
    escmPath.append("package escm.vm.runtime;\n");
    escmPath.append("\n");
  ...
  private static void generateEscmStdlibLoader(String escmDir) {
    String stdlibPath = escmDir+File.separator+"src"+File.separator+"stdlib.scm";
    Path stdlibLoaderPath = Path.of(escmDir+File.separator+"src"+File.separator+"escm"+
                                            File.separator+"vm"+File.separator+"runtime"+
                                            File.separator+"EscmStdLibLoader.java");
    ...
    escmStdlibLoader.append("package escm.vm.runtime;\n");
  ...
  private static String getJavaStdlibLoaderContents(String escmDir) {
    ...
    javaStdlibLoader.append("package escm.vm.runtime;\n");
  ...
  private static void generateJavaStdlibLoader(String escmDir) {
    String contents = getJavaStdlibLoaderContents(escmDir);
    Path stdlibLoaderPath = Path.of(escmDir+File.separator+"src"+File.separator+"escm"+
                                            File.separator+"vm"+File.separator+"runtime"+
                                            File.separator+"JavaStdLibLoader.java");
    try {
      Files.deleteIfExists(stdlibLoaderPath);
  ...
  public static void main(String[] args) {
    ...
    generateEscmPath(escmDir);
    generateEscmStdlibLoader(escmDir);
    generateJavaStdlibLoader(escmDir);
