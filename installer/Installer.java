...
/* Purpose:
  ...
  Compiles/Installs the EScheme runtime. This is done by accomplishing several tasks:
    ...
    5. Serialize the EScheme Standard Library "src/stdlib.scm" by executing "escm --serialize-stdlib"
...
public class Installer {
  ...
  private static void serializeESchemeStdLib(String escmDir) {
    String serializeCmd = "java -classpath "+escmDir+File.separator+"bin Main --serialize-stdlib";
    try {
