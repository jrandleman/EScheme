...
(ut ((fn ((:ac x) #t) ((:any x) #f)) "") #t)
(ut ((fn ((:ac x) #t) ((:any x) #f)) "string") #t)
(ut ((fn ((:ac<char> x) #t) ((:any x) #f)) "string") #t)
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) "string") #f)
(ut ((fn ((:ac x) #t) ((:any x) #f)) '()) #t)
(ut ((fn ((:ac x) #t) ((:any x) #f)) (list 1 2 3)) #t)
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) '()) #t)
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) (list 1 2 3)) #t)
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) (list 1 "2" 3)) #f)
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) (list "1" 2 3)) #f)
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) (list 1 2 "3")) #f)
(ut ((fn ((:ac x) #t) ((:any x) #f)) []) #t)
(ut ((fn ((:ac x) #t) ((:any x) #f)) (vector 1 2 3)) #t)
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) []) #t)
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) (vector 1 2 3)) #t)
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) (vector 1 "2" 3)) #f)
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) (vector "1" 2 3)) #f)
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) (vector 1 2 "3")) #f)
(ut ((fn ((:ac x) #t) ((:any x) #f)) {}) #t)
(ut ((fn ((:ac x) #t) ((:any x) #f)) (hashmap 1 2 3 4)) #t)
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) {}) #t)
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) (hashmap 1 2 3 4)) #t)
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) (hashmap 1 "2" 3 4)) #f)
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) (hashmap "1" 2 3 4)) #t) ; "<type>" only checks values
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) (hashmap 1 2 "3" 4)) #t)
(ut ((fn ((:ac<int> x) #t) ((:any x) #f)) (hashmap 1 2 3 "4")) #f)
(ut ((fn ((:ac x) #t) ((:any x) #f)) 42) #f)
(ut ((fn ((:oc x) #t) ((:any x) #f)) "") #t)
(ut ((fn ((:oc x) #t) ((:any x) #f)) "string") #t)
(ut ((fn ((:oc<char> x) #t) ((:any x) #f)) "string") #t)
(ut ((fn ((:oc<int> x) #t) ((:any x) #f)) "string") #f)
(ut ((fn ((:oc x) #t) ((:any x) #f)) '()) #t)
(ut ((fn ((:oc x) #t) ((:any x) #f)) (list 1 2 3)) #t)
(ut ((fn ((:oc<int> x) #t) ((:any x) #f)) '()) #t)
(ut ((fn ((:oc<int> x) #t) ((:any x) #f)) (list 1 2 3)) #t)
(ut ((fn ((:oc<int> x) #t) ((:any x) #f)) (list 1 "2" 3)) #f)
(ut ((fn ((:oc<int> x) #t) ((:any x) #f)) (list "1" 2 3)) #f)
(ut ((fn ((:oc<int> x) #t) ((:any x) #f)) (list 1 2 "3")) #f)
(ut ((fn ((:oc x) #t) ((:any x) #f)) []) #t)
(ut ((fn ((:oc x) #t) ((:any x) #f)) (vector 1 2 3)) #t)
(ut ((fn ((:oc<int> x) #t) ((:any x) #f)) []) #t)
(ut ((fn ((:oc<int> x) #t) ((:any x) #f)) (vector 1 2 3)) #t)
(ut ((fn ((:oc<int> x) #t) ((:any x) #f)) (vector 1 "2" 3)) #f)
(ut ((fn ((:oc<int> x) #t) ((:any x) #f)) (vector "1" 2 3)) #f)
(ut ((fn ((:oc<int> x) #t) ((:any x) #f)) (vector 1 2 "3")) #f)
(ut ((fn ((:oc x) #t) ((:any x) #f)) {}) #f)
(ut ((fn ((:oc x) #t) ((:any x) #f)) 42) #f)
